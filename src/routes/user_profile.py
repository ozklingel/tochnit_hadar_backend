    ...
    try:
        ...
        for key in data:
            ...
            if key == "region":
                ...
                setattr(updatedEnt, "region_id", RegionId.id)
    ...
    try:
        ...
        if userEnt:
            ...
            regionName = (
                ...
                .filter(Region.id == city.region_id)
                .first()
            )
    ...
    try:
        ...
        if "1" in user1ent.role_ids:
            ...
            userList = (
                ...
                .filter(User.institution_id == user1ent.institution_id)
                .all()
            )
        ...
        for noti in apprenticeList:
            accompany = (
                ...
                .filter(User.id == Apprentice.accompany_id)
                .first()
            )
            ...
            eventlist = (
                ...
                .filter(
                    ...
                    Notification.numoflinesdisplay == 3,
                )
                .all()
            )
            base_id = (
            ...
            my_dict.append(
                {
                    ...
                    "birthday": to_iso(noti.birthday) if noti.birthday else "",
        ...
        for noti in userList:
            reportList = (
                db.session.query(Report.id).filter(Report.user_id == noti.id).all()
            )
            city = db.session.query(City).filter(City.id == noti.city_id).first()
            my_dict.append(
                {
